...
class TestFormattingOfChangeSetDescribes(unittest.TestCase):
    ...
    def test_creation_deletion(self):
        ...
        result = execute('describe-add-remove',
                         'fixtures/descriptions/describe-add-remove.json',
                         '')
    ...
    def test_changes(self):
        """ Changes """
        result = execute('describe-changes',
                         'fixtures/descriptions/describe-changes.json',
                         '')
    ...
    def test_no_changes(self):
        """ No Changes """
        result = execute('describe-no-changes',
                         'fixtures/descriptions/describe-no-changes.json',
                         '')
